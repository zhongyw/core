...
<p><?php p(print_unescaped($l->t('<a href="/index.php/settings/personal#external-storage" target="_blank" rel="noreferrer">You can add external storages in the personal settings</a>'))); ?></p>
</div>
